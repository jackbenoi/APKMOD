<?php $__env->startSection('menu'); ?> General
                        ...
                        <div ng-repeat="detail in details.general_informations.lists track by $index" ng-if="detail.key != 'app_version'">
                            ...
                            <div class="row" ng-if="detail.key == 'cms_upload_logo'">
                                ...
                                <div class="col-md-9 col-sm-8 col-xs-6">
                                    ...
                                    <?php if($isDemo): ?>
                                        <?php echo $__env->make('backend.layouts.common.demo-btn', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.settings.general.partials.js', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
